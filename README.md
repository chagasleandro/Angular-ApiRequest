...
Este projeto é um tutorial de como utilizar o client nativo (API REST) do Framework Angular para requisições HTTP, atrave´s do tema da aula Escola Hello World com o professor Israel Felipe.
